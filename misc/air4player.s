...
keyboard_joyval
		...
		bne.s	.no_up
		add.w	#1,d0
.no_up		cmp.b	#KB_Q,keycode
		bne.s	.no_down
		add.w	#2,d0
.no_down	cmp.b	#KB_P,keycode
		bne.s	.no_left
		add.w	#4,d0
.no_left	cmp.b	#KB_O,keycode
		bne.s	.no_right
		add.w	#8,d0
.no_right	cmp.b	#KB_SPACE,keycode
		bne.s	.no_fire
		add.w	#16,d0
.no_fire	;not.b	d0
		move.b	d0,joyval5	
...
title_pic	incbin	boot:project2/graphix/a2a3.lbm
...
sprite_pic4	incbin  boot:project2/graphix/sprites8.lbm ; 4th sprite pic
sprite_pic5	incbin	boot:project2/graphix/sprites9.lbm ; 5th sprite pic
hardware_pic	incbin	boot:project2/graphix/sprites7.lbm ; Hardware Sprite Pic

block_pic	incbin	boot:project2/graphix/new_background.iff ; Day Background
block_pic2	incbin	boot:project2/graphix/new_background2.iff ; Night BackGround
