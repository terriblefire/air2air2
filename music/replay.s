...
mt_lop3:clr.l	(a2)
	...
	or.b	#2,$bfe001
	move.b	mt_auxspeede,mt_speedEven(a4)
	move.b	mt_auxspeedo,mt_speedOdd(a4)
	lea	mt_voice1(PC),a0
...
mt_nex:	clr.w	mt_pattpos(a4)
	...
	addq.w	#1,mt_endflag ; SJL - set if the song is finished
...
mt_endflag	dc.w	0 	; set when the song is finished
...
mt_periods:
	...
	; SJL added for compatibile
mt_auxspeede:	dc.w	8 	; these should be initialised. FIXME:
mt_auxspeedo:	dc.w	9	; these should be initialised. FIXME
